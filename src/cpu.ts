...
export class Cpu {
    ...
    public set fz(set: boolean) { if (set) this.f |= FLAG_ZERO; else this.f &= FLAG_ZERO_N }
    public get fn(): boolean { return !!(this.f & FLAG_SUBTRACT) }
    public set fn(set: boolean) { if (set) this.f |= FLAG_SUBTRACT; else this.f &= FLAG_SUBTRACT_N }
    public get fh(): boolean { return !!(this.f & FLAG_HALF_CARRY) }
    public set fh(set: boolean) { if (set) this.f |= FLAG_HALF_CARRY; else this.f &= FLAG_HALF_CARRY_N }
    public get fc(): boolean { return !!(this.f & FLAG_CARRY) }
    public set fc(set: boolean) { if (set) this.f |= FLAG_CARRY; else this.f &= FLAG_CARRY_N }
